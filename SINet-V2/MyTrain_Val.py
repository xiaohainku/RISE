...
if __name__ == '__main__':
    ...
    parser.add_argument('--img_root', type=str, default='/root/autodl-tmp/dataset/COD/dataset/TrainDataset/Imgs/',
                        help='the training rgb images root')
    parser.add_argument('--gt_root', type=str, default='/root/autodl-tmp/dataset/COD/dataset/TrainDataset/PseudoMask/', )
    parser.add_argument('--val_root', type=str, default='/root/autodl-tmp/dataset/COD/dataset/TestDataset/CAMO/',
    ...
    # load data
    print('load data...')
    train_loader = get_loader(image_root=opt.img_root,
                              gt_root=opt.gt_root,
