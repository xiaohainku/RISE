...
class Network_CamoScoreRegression(nn.Module):
    # res2net based encoder decoder
    def __init__(self, channel=32, imagenet_pretrained=True):
        super(Network_CamoScoreRegression, self).__init__()
        # ---- ResNet Backbone ----
        self.resnet = res2net50_v1b_26w_4s(pretrained=imagenet_pretrained)
        # ---- Receptive Field Block like module ----
        self.rfb2_1 = RFB_modified(512, channel)
    ...
    def forward(self, x):
        ...
        camo_scores = self.regression_head(x4)
        ...
        return S_g_pred, S_5_pred, S_4_pred, S_3_pred, camo_scores
...
if __name__ == '__main__':
    ...
    net = Network_CamoScoreRegression(imagenet_pretrained=False)
    net.eval()
